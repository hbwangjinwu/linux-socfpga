...
static int ft5406_read_data(void)
{
    ...
    {
        case 5:
            eventx  = (buf[27] & 0x0F)<<8 | buf[28];
	    event->x5 = (eventx*800)/1024;
            event->y5 = (s16)(buf[29] & 0x0F)<<8 | (s16)buf[30];
	    event->y5 = (event->y5/10)<<3;
        case 4:
            eventx =(buf[21] & 0x0F)<<8 | buf[22];
	    event->x4 = (eventx*800)>>10;
            event->y4 = (s16)(buf[23] & 0x0F)<<8 | (s16)buf[24];
	    event->y4 = (event->y4/10)<<3;
        case 3:
            eventx= (buf[15] & 0x0F)<<8 | buf[16];
	    event->x3 = (eventx*800)>>10;
            event->y3 = (s16)(buf[17] & 0x0F)<<8 | (s16)buf[18];
	    event->y3 = (event->y3/10)<<3;
        case 2:
            eventx = (buf[9] & 0x0F)<<8 | buf[10];
            event->x2 = (eventx*800)>>10;
            event->y2 = (s16)(buf[11] & 0x0F)<<8 | (s16)buf[12];
	    event->y2 = (event->y2/10)<<3;
        case 1:
            eventx= (buf[3] & 0x0F)<<8 | buf[4];
            event->x1 = (eventx*800)>>10;
            event->y1 = (s16)(buf[5] & 0x0F)<<8 | (s16)buf[6];
            event->y1 = (event->y1/10)<<3;
            break;
        default:
            return -1;
    }
